...
namespace PlaceEveryItem.List
{
  [JsonObject]
	public class PlaceEveryItemConfig : ModSystem, IEnumerable<KeyValuePair<string, Part>>
	{
		...
		public Part Barrel { get; set; } = new Part(false, $"{qr}");
		public Part Bed { get; set; } = new Part(false, $"{qr}");
		public Part BloomeryParts { get; set; } = new Part(false, $"{qr} (base, chimney)");		
		public Part Chair { get; set; } = new Part(false, $"{qr}");
		public Part Chandelier { get; set; } = new Part(false, $"{qr}");
		public Part Chest { get; set; } = new Part(false, $"{qr} (All)");
		public Part Chimney { get; set; } = new Part(false, $"{qr}");
		public Part ChutesEtc { get; set; } = new Part(false, $"{qr} (including archimedes screw)");
		public Part DisplayCase { get; set; } = new Part(false, $"{qr}");
		public Part Distiller { get; set; } = new Part(false, $"{qr} (condenser, boiler)");
		public Part Door { get; set; } = new Part(false, $"{qr} (wooden, rough, iron, coke oven)");
		public Part EchoChamber { get; set; } = new Part(false, $"{qr}");
		public Part FruitPress { get; set; } = new Part(false, $"{qr}");
		public Part Hopper { get; set; } = new Part(false, $"{qr}");
		public Part Mechanics { get; set; } = new Part(false, $"{qr} (All except axle and angled gear)");
		public Part MetalBlock { get; set; } = new Part(false, $"{qr}");
		public Part MoldRack { get; set; } = new Part(false, $"{qr}");
		public Part Omok { get; set; } = new Part(false, $"{qr}");
		public Part Planter { get; set; } = new Part(false, $"{qr}");
		public Part Quern { get; set; } = new Part(false, $"{qr}");
		public Part ReedBasket { get; set; } = new Part(false, $"{qr}");
		public Part Shelf { get; set; } = new Part(false, $"{qr}");
		public Part SignPost { get; set; } = new Part(false, $"{qr}");
		public Part SticksLayer { get; set; } = new Part(false, $"{qr}");
		public Part StoneCoffinBoth { get; set; } = new Part(false, $"{qr}");
		public Part StorageVessel { get; set; } = new Part(false, $"{qr}");
		public Part Table { get; set; } = new Part(false, $"{qr}");
		public Part Torch { get; set; } = new Part(false, $"{qr}");
		public Part WoodenPath { get; set; } = new Part(false, $"{qr}");
